...
;;;;;;;;;;;; Using these initial conditions the planner computes a plan where two sensors compute acquisition in the same location
;;;;;;;;;;;; (one sensor computes two acquisitions while the other computes one acquisition)
;;;;;;;;;;;; the last sensor is used in a different location
...
(:init
    ...
    (sensorsoil spectrocamera soil1 halfpi)
    ...
    (acquiredTwice spectrocamera soil1)
